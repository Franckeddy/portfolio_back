...
class Company
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Candidat", inversedBy="companies", cascade={"persist"})
     * @ORM\JoinTable(name="company_candidat")
     */
    private $candidat;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\ActivityArea", mappedBy="company", cascade={"persist"})
